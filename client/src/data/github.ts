...
export const fallbackGitHubActivity: GitHubActivity[] = [
  ...
  },
  {
    id: 'ev-1',
    type: 'PushEvent',
    repoName: 'mrityunjay45108/ai-interview-copilot',
    repoUrl: 'https://github.com/mrityunjay45108/ai-interview-copilot',
    createdAt: new Date(Date.now() - 2 * 3600 * 1000).toISOString(),
    description: 'Pushed 3 commits to mrityunjay45108/ai-interview-copilot',
    commits: [
